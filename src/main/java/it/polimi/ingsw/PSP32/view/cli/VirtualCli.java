...
public class VirtualCli implements Runnable {
    ...
    public static int getNumOfPlayers(){
        ...
        out("\n\n----------------------------------------------------------------------------------------------------------------------------------------------------\n" +
                "----------____--------____----------_____-------____-- _____________------_________------__________---- ____-- _____------ ____ --____--------\n" +
                "--------/     |------/    \\--------|     \\-----|    |-|             |----/         \\----|   ____   \\---|    |-|     \\-----|    |-|    |------\n" +
                "-------/  ____|-----/      \\-------|      \\----|    |-|____     ____|---/           \\---|  |----\\   \\--|    |-|      \\----|    |-|    |---\n" +
                "------|  |---------/   /\\   \\------|       \\---|    |------|    |------/     ___     \\--|  |---- |   |-|    |-|       \\---|    |-|    |-------\n" +
                "-------\\  \\-------/   /__\\   \\-----|    |\\  \\--|    |------|    |-----|     /---\\     |-|  |____/   / -|    |-|    |\\  \\--|    |-|    |----\n" +
                ...
                "------____|  |-/      /--\\      \\--|    |---\\       |------|    |------\\             /--|   | \\   \\----|    |-|    |---\\       |-|    |-----\n" +
                "-----|       //      /----\\      \\-|    |----\\      |------|    |-------\\           /---|   |  \\   \\---|    |-|    |----\\      |-|    |-------\n" +
                "-----|______//______/------\\______\\|____|-----\\_____|------|____|--------\\_________/----|___|---\\___\\--|____|-|____|-----\\_____|-|____|-----\n" +
                "------------------------------------------------------------------------------------------------------------------------------------------------------\n" +
