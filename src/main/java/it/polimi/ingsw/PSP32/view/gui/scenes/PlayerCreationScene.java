...
public class PlayerCreationScene  extends Gui {
  ...
  public PlayerCreationScene(){
    ...
    ImageIcon twoPawnImage = new ImageIcon(getClass().getResource("/Santorini Images/SchermataCreazioneGiocatore/2Players.png"));
    ...
    twoPawnImage = new ImageIcon(getClass().getResource("/Santorini Images/SchermataCreazioneGiocatore/2PlayersSelezionato.png"));
    img = twoPawnImage.getImage();
    newImg = img.getScaledInstance( (int)(240*scale), (int)(180*scale),  java.awt.Image.SCALE_SMOOTH  ) ;
    ...
    ImageIcon threePawnImage = new ImageIcon(getClass().getResource("/Santorini Images/SchermataCreazioneGiocatore/3Players.png"));
    img = threePawnImage.getImage();
    newImg = img.getScaledInstance( (int)(240*scale), (int)(180*scale),  java.awt.Image.SCALE_SMOOTH  ) ;
    threePlayersIcon = new ImageIcon(newImg);

    threePawnImage = new ImageIcon(getClass().getResource("/Santorini Images/SchermataCreazioneGiocatore/3PlayersSelezionato.png"));
    img = threePawnImage.getImage();
